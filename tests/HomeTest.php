...
final class HomeTest extends TestCase
{
    ...
    public function testModels(): void
    {
        ...
        // la fonction findTest est une fonction créée dans le DashboardManager pour récupérer l'id de la chanson 'roule'
        $this->assertEquals('2', $this->DashboardManager->findTest('roule'));
    }
    ...
    public function testModels3(): void
    {
        ...
        // La fonction getEmailUnique est une fonction créée dans le DashboardManager pour récupérer un utilisateur par email
